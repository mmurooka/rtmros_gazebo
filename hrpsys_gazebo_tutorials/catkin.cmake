...
if(EXISTS ${hrpsys_ros_bridge_tutorials_SOURCE_DIR})
  set(hrpsys_ros_bridge_tutorials_PACKAGE_PATH ${hrpsys_ros_bridge_tutorials_SOURCE_DIR})
else()
  set(hrpsys_ros_bridge_tutorials_PACKAGE_PATH ${hrpsys_ros_bridge_tutorials_PREFIX}/share/hrpsys_ros_bridge_tutorials)
endif()
include(${hrpsys_gazebo_general_PACKAGE_PATH}/cmake/compile_robot_model_for_gazebo.cmake)
generate_gazebo_urdf_file(${hrpsys_ros_bridge_tutorials_PACKAGE_PATH}/models/SampleRobot.dae)
generate_gazebo_urdf_file(${hrpsys_ros_bridge_tutorials_PACKAGE_PATH}/models/HRP3HAND_L.dae)
generate_gazebo_urdf_file(${hrpsys_ros_bridge_tutorials_PACKAGE_PATH}/models/HRP3HAND_R.dae)
generate_gazebo_urdf_file(${hrpsys_ros_bridge_tutorials_PACKAGE_PATH}/models/HRP2JSK.dae)
generate_gazebo_urdf_file(${hrpsys_ros_bridge_tutorials_PACKAGE_PATH}/models/HRP2JSKNT.dae)
generate_gazebo_urdf_file(${hrpsys_ros_bridge_tutorials_PACKAGE_PATH}/models/HRP2JSKNTS.dae)
generate_gazebo_urdf_file(${hrpsys_ros_bridge_tutorials_PACKAGE_PATH}/models/STARO.dae)
generate_gazebo_urdf_file(${hrpsys_ros_bridge_tutorials_PACKAGE_PATH}/models/HRP4C.dae)
